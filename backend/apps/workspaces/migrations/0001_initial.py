# Generated by Django 6.0.2 on 2026-02-07 01:26
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('role', models.CharField(choices=[('team_leader', 'Team Leader'), ('colaborator', 'Colaborator'), ('client', 'Client')], default='colaborator', max_length=20)),
